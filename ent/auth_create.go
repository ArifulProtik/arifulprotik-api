...
func (ac *AuthCreate) SetRfUUID(u uuid.UUID) *AuthCreate {
	ac.mutation.SetRfUUID(u)
	return ac
}
...
func (ac *AuthCreate) SetRfToken(s string) *AuthCreate {
	ac.mutation.SetRfToken(s)
	return ac
}
...
func (ac *AuthCreate) SetExpireAt(i int64) *AuthCreate {
	ac.mutation.SetExpireAt(i)
	return ac
}
...
func (ac *AuthCreate) check() error {
	if _, ok := ac.mutation.Userid(); !ok {
		return &ValidationError{Name: "userid", err: errors.New(`ent: missing required field "Auth.userid"`)}
	}
	if _, ok := ac.mutation.RfUUID(); !ok {
		return &ValidationError{Name: "rf_uuid", err: errors.New(`ent: missing required field "Auth.rf_uuid"`)}
	}
	if _, ok := ac.mutation.IsBlocked(); !ok {
		return &ValidationError{Name: "is_blocked", err: errors.New(`ent: missing required field "Auth.is_blocked"`)}
	}
	if _, ok := ac.mutation.RfToken(); !ok {
		return &ValidationError{Name: "rf_token", err: errors.New(`ent: missing required field "Auth.rf_token"`)}
	}
	if _, ok := ac.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "Auth.created_at"`)}
	}
	if _, ok := ac.mutation.ExpireAt(); !ok {
		return &ValidationError{Name: "expire_at", err: errors.New(`ent: missing required field "Auth.expire_at"`)}
	}
	return nil
}
...
func (ac *AuthCreate) createSpec() (*Auth, *sqlgraph.CreateSpec) {
	...
	if value, ok := ac.mutation.RfUUID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
	...
	if value, ok := ac.mutation.RfToken(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
